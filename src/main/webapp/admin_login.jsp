            ...
            <div class="w-full max-w-md">
                ...
                <form action="admin_dashboard.jsp" method="POST">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <label class="flex items-center space-x-2 cursor-pointer text-gray-600 text-sm">
                            <input type="checkbox" class="w-4 h-4 text-gray-800 rounded focus:ring-gray-800">
                            <span>Ghi nhớ đăng nhập</span>
                        </label>
                        <a href="#" class="text-sm font-semibold text-gray-600 hover:text-gray-900 transition-colors">Quên mật khẩu?</a>
                    </div>
